                    ...
                    <div class="row">
                        <div class="col-md-12 mb-4">
                            ...
                            <div class="table-data__tool">
                                ...
                                <form class="form-header" action="/admin/categories" method="POST">
                                    {{ csrf_field() }} 
                                ...
                                <div class="table-data__tool-right">
                                    <a href="/admin/category/add" class="au-btn au-btn-icon au-btn--green au-btn--small text-white">
